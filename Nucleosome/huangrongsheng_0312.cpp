...
{
    string base_dir = "C:/Nucleosome/output/";
...
void start_simulation()
{
    ...
    vector<double> propensity_list = {0.008,0.008, 0.04, 0.04};
    ...
    vector<double> nuceo_to_cpg_efficiency = {0.232, -0.01};


    vector<int> index_pos_list;

    //当前文件夹的全路径
    string path_dir="C:/Nucleosome/";
